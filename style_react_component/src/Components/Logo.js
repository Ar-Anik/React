...
function Logo() {
    ...
    // const ChangeColor = () => {
    //     const arr = ["red", "green", "blue", "black", "yellow", "tomato", "indigo", "pink", "khaki"];
    //     const clrs = arr[Math.floor(Math.random()*arr.length)];
    //     // console.log(clrs);
    //     return clrs;
    // }
    ...
    return (
        <div className={styles.logo}>
            ...
            <div className={styles.glasses}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.63 42.68">
                    <g>
                        <g>
                            <rect
                                className={`${styles.coloredLine} ${styles.shadow} border`}
                                x="30.08"
                                y="11.04"
                                width="2.54"
                                height="15.01"
                            ...
                            <rect
                                className={[styles.coloredLine, styles.shadow, 'border'].join(' ')}
                                x="82.73"
                                y="6.54"
                                width="2.53"
                                height="12.68"
            ...
            <div className={styles.play}>
                {/* <button className={styles.shadow} type="button" onClick={() => 
                    setClr(ChangeColor())
                }>Colorize Glass</button> */}

                <button className={styles.shadow} type="button" onClick={() => ChangeColor()}>Colorize Glass</button>

                <button type="button" onClick={()=> setClr('black')}>Reset Glass</button>
            </div>
